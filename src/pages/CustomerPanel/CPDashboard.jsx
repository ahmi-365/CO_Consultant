        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 mb-8">
          {[1, 2, 3, 4].map((i) => (
            <div key={i} className="bg-white rounded-lg shadow-sm border p-6">
              ...
              <div className="h-10 bg-gray-200 rounded w-24 mb-2 animate-pulse"></div>
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-4 md:p-6 lg:p-8">
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-600 mt-2">Manage your files and storage efficiently</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 mb-8">
        ...
        >
          ...
          <div className="text-2xl md:text-3xl font-bold text-gray-900">{storage?.used || '0 MB'}</div>
        ...
        >
          ...
          <div className="text-2xl md:text-3xl font-bold text-gray-900">{starredFiles || 0}</div>
        ...
        >
          ...
          <div className="text-2xl md:text-3xl font-bold text-gray-900">{trashedFiles || 0}</div>
      ...
      <div className="grid grid-cols-1 gap-6">
        ...
        <div className="bg-white rounded-lg shadow-sm border">
          <div className="p-6 border-b">
            ...
            <p className="text-sm text-gray-600 mt-1">Latest actions in your storage</p>
          </div>
