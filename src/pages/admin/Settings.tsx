...
import { Settings as SettingsIcon, Shield, Bell, Database, Mail, Key, Users, Globe } from "lucide-react";
...
export default function Settings() {
  ...
  const toggleSecuritySetting = (id: string) => {
    ...
    toast({
      ...
      description: `${id.replace('-', ' ')} has been ${securitySettings[id as keyof typeof securitySettings] ? 'disabled' : 'enabled'}`,
    });
  };
  ...
  const toggleNotificationSetting = (id: string) => {
    ...
    toast({
      ...
      description: `${id.replace('-', ' ')} notifications have been ${notifications[id as keyof typeof notifications] ? 'disabled' : 'enabled'}`,
    });
  };
  ...
  return (
    <div className="p-8">
      <div className="mb-8">
        ...
        <p className="text-muted-foreground mt-1">Manage your organization and system settings</p>
      </div>
        ...
        <div className="space-y-6">
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <Button onClick={handleSaveOrgSettings}>Save Organization Settings</Button>
            </CardContent>
          </Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <div className="text-xs text-muted-foreground">Let new users sign up without invitation</div>
                </div>
                <Switch 
            ...
            <CardContent>
              <div className="space-y-4">
                {securitySettingsList.map((setting) => (
                  <div key={setting.id} className="flex items-center justify-between p-3 border border-border rounded-lg">
                    <div className="flex-1">
                      <div className="font-medium text-sm">{setting.label}</div>
                      <div className="text-xs text-muted-foreground">{setting.description}</div>
                    </div>
                    <Switch 
                      checked={securitySettings[setting.id as keyof typeof securitySettings]}
              ...
              <div className="space-y-3">
                ...
                <Button variant="outline" size="sm" className="w-full" onClick={handleRegenerateApiKeys}>
          ...
          <Card>
            ...
            <CardContent>
              ...
              <div className="space-y-3">
                ...
                />
                <Button variant="outline" size="sm" className="w-full" onClick={handleTestEmailConfig}>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="text-sm text-muted-foreground">
                <p><strong>Last Backup:</strong> December 8, 2024 at 3:00 AM</p>
                <p><strong>System Version:</strong> v2.1.4</p>
